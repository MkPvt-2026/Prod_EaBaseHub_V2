  ...
  try {
    ...
    container.innerHTML = unique
      .map((c) => {
        ...
        return `
        <div class="comment-item ${roleClass}" style="padding:8px 10px;margin-bottom:6px;">
          ...
          <div class="comment-text" style="margin-top:4px;">${renderCommentText(c.comment)}</div>
        </div>`;
      })
      .join("");
  } catch (e) {
